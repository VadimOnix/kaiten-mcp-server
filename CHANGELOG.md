...
* **docker:** build natively instead of wedging QEMU on npm ci ([da22be2](https://github.com/VadimOnix/kaiten-mcp-server/commit/da22be2caa6c4bc3559f8b47ae28602455144f6b))
