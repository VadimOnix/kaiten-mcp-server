...
This is an MCP (Model Context Protocol) server for Kaiten API integration. It provides 22 tools for managing Kaiten cards, comments, spaces, and boards directly from Claude Desktop. The server is production-ready with comprehensive logging, caching, retry logic, and concurrency control.
...
Coverage targets the pure, deterministic layers that back the 22 tools:
